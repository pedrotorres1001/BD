...
```
Entidades: Produtos,Items,Econcomenda,Forncecedor,Tipo de Fornecedores

Atributos: Preço,Código,Unidades,Taxa Iva,Nome (Entidade Produtos)
           Quantidade(Entidade Items)
           Número,Data(Entidade Encomenda)
           Morada,Nome,NIF,Número Fax (Entidade Fornecedor)
           Código,Designação (Entidade Tipo Fornecedor)
           Código,Designação (Condições Pagamento)

Relações da BD: Tem(Relação entre as entidades Produtos e Items)
                Possui(Relação entre as entidades Encomenda e Items)
                Tem(Relação entre as entidades Encomenda e Fornecedor)
                Tem(Relação entre as entidades Fornecedor e Tipo de Fornecedor)
                Tem(Relação entre as entidades Fornecedor e Condições Pagamento)
